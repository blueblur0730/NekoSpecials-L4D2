...
Action RefreshHUD(Handle timer)
{
	if (!HudRunning)
		return Plugin_Stop;

	if (NCvar_NekoKillHud[CKillHud_HudStyle].IntValue <= 3 && NCvar_NekoKillHud[CKillHud_HudStyle].IntValue > 0)
	{
		...
		if (NCvar_NekoKillHud[CKillHud_KillSpecials].BoolValue)
		{
			...
			for (int i = 0; i < PlayerKillNum.Length; i++)
			{
				...
				if (i < PlayerLimit)
				{
					if (i > 3 && NCvar_NekoKillHud[CKillHud_ShowMorePlayer].BoolValue)
					{
						PlayerCounts++;
			...
			if (PlayerCount > 4 && NCvar_NekoKillHud[CKillHud_ShowMorePlayer].BoolValue)
		...
		switch (NCvar_NekoKillHud[CKillHud_HudStyle].IntValue)
		{
			...
			case 3:
			{
				...
				if (NCvar_NekoKillHud[CKillHud_KillSpecials].BoolValue)
				{
					NCvar_NekoKillHud[CKillHud_CStyleSpecialsXY].GetString(GetCharValue, sizeof GetCharValue);
				...
				if (NCvar_NekoKillHud[CKillHud_FriendlyFire].BoolValue)
				{
					NCvar_NekoKillHud[CKillHud_CStyleFriendXY].GetString(GetCharValue, sizeof GetCharValue);
					GetHUDSide(GetCharValue, xy);
					if (NCvar_NekoKillHud[CKillHud_ShowMorePlayer].BoolValue)
				...
				if (NCvar_NekoKillHud[CKillHud_AllKill].BoolValue)
				{
					NCvar_NekoKillHud[CKillHud_CStyleAllKillXY].GetString(GetCharValue, sizeof GetCharValue);
					GetHUDSide(GetCharValue, xy);
	...
	else if (NCvar_NekoKillHud[CKillHud_HudStyle].IntValue == 4)
	{
		if (StyleChatDelay < 0)
		{
